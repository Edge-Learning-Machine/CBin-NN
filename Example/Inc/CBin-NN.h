// Uncomment next instruction when using an IDE and in main.c (in the used IDE) add bnn_main() inside their main function;
// #include "main.h"
#include <stdio.h>
#include <stdbool.h>
...
void BBQFC(int out[], int out_dim, int in_dim, int bias[], int weight[], float bn_wt[], int input[]);
void BBQFC_Optimized(int out[], int out_dim, int in_dim, int bias[], int weight[], float bn_wt[], int input[]);
void BBQFC_Optimized_PReLU(int out[], int out_dim, int in_dim, int bias[], int weight[], float bn_wt[], float shift[], int input[]);

// Find a proper quantization function that allow the fusion offline
